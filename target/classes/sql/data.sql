...
('salary', 'sal', '薪资', '5000 <= salary <= 10000', 'DOUBLE', '按薪资范围查询的配置（闭区间）'),
('email', 'mail', '邮箱', 'email NA', 'STRING', '查询邮箱为空的配置'),
('phone', 'mobile', '手机', 'phone != 空', 'STRING', '查询手机不为空的配置'),
('field', 'default', '默认字段', '> 0', 'INTEGER', '默认字段大于0的配置');
...
-- 添加更多配置示例，展示各种操作符
INSERT INTO filter_config (field_name, field_alias, field_chinese_name, filter_expression, field_type, description) VALUES
('age', 'ageRange', '年龄区间', '20 < age <= 30', 'INTEGER', '年龄左开右闭区间查询'),
('score', 'scoreRange', '分数区间', '80 <= score < 100', 'DOUBLE', '分数左闭右开区间查询'),
('salary', 'salaryOpen', '薪资开区间', '6000 < salary < 12000', 'DOUBLE', '薪资开区间查询'),
